...
export const pollutionHotspots: PollutionPoint[] = [
  ...
  // ── Greater Bengaluru cluster (around device location 12.96, 77.59) ──
  { id: "KA-BLR-01", lat: 12.9784, lng: 77.6408, aqi: 142, pollutant: "PM2.5", severity: "Unhealthy", label: "MG Road / Trinity Circle", state: "Karnataka", street: "MG Road, Bengaluru", description: "Central business district; metro construction + dense traffic." },
  { id: "KA-BLR-02", lat: 12.9279, lng: 77.6271, aqi: 118, pollutant: "NO2", severity: "Unhealthy", label: "HSR Layout 27th Main", state: "Karnataka", street: "27th Main Road, HSR Layout", description: "Tech corridor commute traffic; NO₂ peaks at evening rush." },
  { id: "KA-BLR-03", lat: 12.9698, lng: 77.7500, aqi: 165, pollutant: "PM10", severity: "Unhealthy", label: "Whitefield ITPL Road", state: "Karnataka", street: "ITPL Main Road, Whitefield", description: "IT cluster construction dust; Phase 2 metro work ongoing." },
  { id: "KA-BLR-04", lat: 13.0359, lng: 77.5970, aqi: 132, pollutant: "PM2.5", severity: "Unhealthy", label: "Yeshwanthpur Industrial", state: "Karnataka", street: "Tumkur Road, Yeshwanthpur", description: "Mixed industrial belt; truck movement and small factory emissions." },
  { id: "KA-BLR-05", lat: 12.8456, lng: 77.6603, aqi: 124, pollutant: "PM2.5", severity: "Unhealthy", label: "Electronics City Phase 1", state: "Karnataka", street: "Hosur Road, Electronics City", description: "Hosur Road choke point; diesel exhaust from inter-state buses." },
  { id: "KA-BLR-06", lat: 13.0488, lng: 77.6105, aqi: 98, pollutant: "PM10", severity: "Moderate", label: "Hebbal Flyover", state: "Karnataka", street: "Bellary Road, Hebbal", description: "Airport corridor congestion; flyover bottleneck during peak." },
  { id: "KA-BLR-07", lat: 12.9081, lng: 77.5829, aqi: 105, pollutant: "NO2", severity: "Unhealthy", label: "Banashankari Bus Stand", state: "Karnataka", street: "Outer Ring Road, Banashankari", description: "Major BMTC depot; idling buses raise NO₂." },
  { id: "KA-BLR-08", lat: 12.9591, lng: 77.7011, aqi: 138, pollutant: "PM2.5", severity: "Unhealthy", label: "Marathahalli Bridge", state: "Karnataka", street: "Outer Ring Road, Marathahalli", description: "ORR tech corridor; infamous for evening pollution spikes." },
  { id: "KA-BLR-09", lat: 13.0067, lng: 77.5631, aqi: 88, pollutant: "PM10", severity: "Moderate", label: "Malleshwaram 8th Cross", state: "Karnataka", street: "Sampige Road, Malleshwaram", description: "Heritage residential; moderate dust from neighbourhood roads." },
  { id: "KA-BLR-10", lat: 12.9141, lng: 77.6101, aqi: 152, pollutant: "PM2.5", severity: "Unhealthy", label: "BTM Layout 2nd Stage", state: "Karnataka", street: "Bannerghatta Road, BTM", description: "Bannerghatta Road jam belt; high commuter density." },
  { id: "KA-BLR-11", lat: 12.9886, lng: 77.5614, aqi: 92, pollutant: "PM2.5", severity: "Moderate", label: "Rajajinagar Industrial", state: "Karnataka", street: "Tumkur Road, Rajajinagar", description: "Old industrial estate; legacy small-scale units." },
  { id: "KA-BLR-12", lat: 12.9116, lng: 77.6469, aqi: 115, pollutant: "NO2", severity: "Unhealthy", label: "Bommanahalli Junction", state: "Karnataka", street: "Hosur Road, Bommanahalli", description: "Tech park access road; saturation during morning peak." },
  { id: "KA-BLR-13", lat: 12.9352, lng: 77.5347, aqi: 78, pollutant: "PM10", severity: "Moderate", label: "Kengeri Satellite Town", state: "Karnataka", street: "Mysore Road, Kengeri", description: "Outer fringe; sand transport from quarries on Mysore Road." },
  { id: "KA-BLR-14", lat: 13.0606, lng: 77.5852, aqi: 86, pollutant: "PM2.5", severity: "Moderate", label: "Yelahanka New Town", state: "Karnataka", street: "Doddaballapur Road, Yelahanka", description: "Rapidly developing northern suburb; construction dust." },
  { id: "KA-BLR-15", lat: 12.9698, lng: 77.5111, aqi: 132, pollutant: "PM10", severity: "Unhealthy", label: "Nayandahalli Quarry Belt", state: "Karnataka", street: "Mysore Road, Nayandahalli", description: "Stone quarries and crusher units; PM10 chronically elevated." },
  { id: "KA-BLR-16", lat: 12.9165, lng: 77.5012, aqi: 72, pollutant: "PM2.5", severity: "Moderate", label: "Kanakapura Road", state: "Karnataka", street: "Kanakapura Main Road, Konanakunte", description: "Suburban arterial; growing apartment density." },
  { id: "KA-BLR-17", lat: 12.9889, lng: 77.6884, aqi: 145, pollutant: "PM2.5", severity: "Unhealthy", label: "KR Puram Bridge", state: "Karnataka", street: "Old Madras Road, KR Puram", description: "Choke-point connecting Whitefield to city; metro construction." },
  { id: "KA-BLR-18", lat: 12.9569, lng: 77.7011, aqi: 128, pollutant: "CO2", severity: "Unhealthy", label: "Bellandur Lake", state: "Karnataka", street: "Outer Ring Road, Bellandur", description: "Lake-side IT corridor; froth and methane plus traffic CO₂." },

  // ── Surrounding south-Indian cities (within 350 km of Bengaluru) ──
  { id: "KA-MYS-01", lat: 12.3052, lng: 76.6552, aqi: 64, pollutant: "PM2.5", severity: "Moderate", label: "Mysuru Devaraja Market", state: "Karnataka", street: "Devaraja Mohalla, Mysuru", description: "Dense old-city traffic and market congestion." },
  { id: "KA-MYS-02", lat: 12.4244, lng: 76.6932, aqi: 58, pollutant: "PM10", severity: "Moderate", label: "Mysuru Ring Road", state: "Karnataka", street: "Outer Ring Road, Mysuru", description: "Long-haul truck movement; moderate dust." },
  { id: "KA-TUM-01", lat: 13.3392, lng: 77.1010, aqi: 82, pollutant: "PM10", severity: "Moderate", label: "Tumakuru Industrial Belt", state: "Karnataka", street: "B.H. Road, Tumakuru", description: "Auto-component clusters and roadside dust." },
  { id: "KA-MND-01", lat: 12.5226, lng: 76.8973, aqi: 55, pollutant: "PM2.5", severity: "Moderate", label: "Mandya Sugar Belt", state: "Karnataka", street: "Bengaluru-Mysuru Highway, Mandya", description: "Sugar mill emissions during crushing season." },
  { id: "KA-HSN-01", lat: 13.0072, lng: 76.0962, aqi: 48, pollutant: "PM10", severity: "Good", label: "Hassan Bypass", state: "Karnataka", street: "NH-75, Hassan Bypass", description: "Mostly clean; minor highway dust." },

  { id: "TN-HSR-01", lat: 12.7409, lng: 77.8253, aqi: 96, pollutant: "PM2.5", severity: "Moderate", label: "Hosur SIPCOT", state: "Tamil Nadu", street: "SIPCOT Industrial Area, Hosur", description: "Auto-component and EV manufacturing belt." },
  { id: "TN-VLR-01", lat: 12.9165, lng: 79.1325, aqi: 88, pollutant: "PM10", severity: "Moderate", label: "Vellore CMC Junction", state: "Tamil Nadu", street: "Bagayam Road, Vellore", description: "Hospital traffic plus highway through-flow." },
  { id: "TN-KRR-01", lat: 11.3410, lng: 77.7172, aqi: 102, pollutant: "PM10", severity: "Unhealthy", label: "Erode Textile Cluster", state: "Tamil Nadu", street: "Perundurai Road, Erode", description: "Dyeing and textile process emissions." },
  { id: "TN-CBE-01", lat: 11.0168, lng: 76.9558, aqi: 78, pollutant: "PM2.5", severity: "Moderate", label: "Coimbatore Gandhipuram", state: "Tamil Nadu", street: "Avinashi Road, Gandhipuram", description: "Central commercial hub; dense vehicle flow." },

  { id: "AP-AND-01", lat: 14.4426, lng: 79.9865, aqi: 72, pollutant: "PM2.5", severity: "Moderate", label: "Nellore Bypass", state: "Andhra Pradesh", street: "NH-16, Nellore Bypass", description: "Coastal highway corridor; moderate PM2.5." },
  { id: "AP-CTR-01", lat: 13.2172, lng: 79.1003, aqi: 68, pollutant: "PM10", severity: "Moderate", label: "Chittoor Junction", state: "Andhra Pradesh", street: "Tirupati Road, Chittoor", description: "Pilgrimage route traffic." },
  { id: "AP-ATP-01", lat: 14.6819, lng: 77.6006, aqi: 92, pollutant: "PM10", severity: "Moderate", label: "Anantapur Highway", state: "Andhra Pradesh", street: "NH-44, Anantapur", description: "Arid region; wind-blown dust over highway." },

  { id: "KL-KCH-01", lat: 9.9816, lng: 76.2999, aqi: 70, pollutant: "PM2.5", severity: "Moderate", label: "Kochi Vyttila Hub", state: "Kerala", street: "Sea Port-Air Port Road, Vyttila", description: "Major mobility hub junction; congested at peak." },
  { id: "KL-CLT-01", lat: 11.2588, lng: 75.7804, aqi: 58, pollutant: "PM10", severity: "Moderate", label: "Kozhikode Beach Road", state: "Kerala", street: "Beach Road, Kozhikode", description: "Coastal town; moderate vehicle and salt aerosol." },
];
